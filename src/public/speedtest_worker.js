...
var settings = {
    ...
    time_ul_max: 30, // max duration of upload test in seconds
    time_dl_max: 30, // max duration of download test in seconds
    ...
    time_dlGraceTime: 5, //time to wait in seconds before actually measuring dl speed (wait for TCP window to increase)
    ...
    xhr_ulMultistream: 10, // number of upload streams to use (can be different if enable_quirks is active)
    xhr_multistreamDelay: 300, //how much concurrent requests should be delayed
    xhr_ignoreErrors: 1, // 0=fail on errors, 1=attempt to restart a stream if it fails, 2=ignore all errors
    xhr_dlUseBlob: false, // if set to true, it reduces ram usage but uses the hard drive (useful with large garbagePhp_chunkSize and/or high xhr_dlMultistream)
    xhr_ul_blob_megabytes: 100, //size in megabytes of the upload blobs sent in the upload test (forced to 4 on chrome mobile)
    garbagePhp_chunkSize: 1000, // size of chunks sent by garbage.php (can be different if enable_quirks is active)
...
module.exports = speedtestWorker;
